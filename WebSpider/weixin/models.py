...
class WeiXin(models.Model):
    ...
    Title=models.CharField(max_length=500,null=False,verbose_name='标题')
    Downloadurl=models.CharField(max_length=2048,null=False,verbose_name='下载')
...
class WeiXinAdmin(admin.ModelAdmin):
    ...
    list_display=('Title','created','Downloadurl_url')
